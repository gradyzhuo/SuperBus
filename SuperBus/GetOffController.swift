...
class GetOffController: UITableViewController {
    ...
    var getOffIndex : Int = -1
    
    let stations311 = ["中和高中","連城路","連城中正路口","連城錦和路口","台貿一村","連城板南路","連城景平路","泰和街中和廟口","中和派出所","南山高中","雙和里","華泰新城","宜安路","宜安吉立智光商職","中興二村","中興新村","得和路口","永和國小","金銀大廈","福和里","福和路","永福橋頭","自來水博物館(太子學舍)","三軍總醫院","耕莘文教院","台電大樓","臺大臺大綜合體育館","龍安國小(公務人力發展中心)","金華新生路口","信義新生路口","幸安國小","仁愛建國路口(一)","仁愛建國路口(二)","仁愛大安路口","仁愛敦化路口","仁愛安和路口","仁愛國泰醫院","仁愛延吉街口","仁愛光復路口","國父紀念館市政府(市府)","松山高中(基隆路)","基隆路口","饒河街觀光夜市(八德)","松山農會","松山車站","松山橋頭","松山車站(八德)","松山農會","饒河街觀光夜市(八德)","基隆路口二松山高中(基隆路)","市政府(市府)","國父紀念館","仁愛光復路口","仁愛延吉街口","仁愛國泰醫院","仁愛安和路口","仁愛敦化路口","仁愛復興路口","仁愛建國路口","一信義新生路口","金華新生路口","和平新生路口","龍安國小(公務人力發展中心)","臺大綜合體育館","臺大捷運公館站","福和橋","福和國中","永利路","金銀大廈","永和國小","得和路口","中興新村","中興二村","智光商職","宜安吉立","宜安路","華泰新城","雙和里南山高中","中和派出所","中和廟口","泰和街","連城景平路","連城板南路","台貿一村","連城錦和路口","連城中正路口","連城路","中和高中"]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if indexPath.row == getOffIndex {
            cell.textLabel?.text = stations311[indexPath.row] + " 下車"
